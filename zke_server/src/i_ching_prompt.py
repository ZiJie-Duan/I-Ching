...
class IChingPrompt:
    ...
    def front_system_prompt_gptmsg(self, prompt:str,
    ...
    def back_system_prompt_gptmsg(self, message_list,
    ...
    def front_back_system_prompt_gptmsg(self, prompt_front:str, 
                                       prompt_back, message_list)->str:
    ...
    def add_assistant_message_gptmsg(self, message:str,
                    message_list:List[Dict[str, str]])->List[Dict[str, str]]:
        return self.add_role_message_gptmsg(message, "assistant", message_list)
    ...
    def safe_check_gptmsg(self, question:str)->str:
        ...
        return self.single_query(self.safe_check(question))


    def summarize_relevant_bg_info(self, question, bg_info:str)->str:

        return "提取背景信息，将背景信息中与问题相关的内容总结为一句话，30个字。\n问题：{}\n背景信息：{}".format(question, bg_info)
    
    
    def summarize_relevant_bg_info_gptmsg(self, question, bg_info:str)->List[Dict[str, str]]:

        return self.single_query(self.summarize_relevant_bg_info(question, bg_info))
